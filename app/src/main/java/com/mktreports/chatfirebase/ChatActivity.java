...
public class ChatActivity extends AppCompatActivity {
    ...
    private void fetchMessages() {
        if (me != null){
            ...
            FirebaseFirestore.getInstance().collection("/conversations")
                    .document(fromId)
                    .collection(toId)
                    .orderBy("timesstamp", Query.Direction.ASCENDING)
    ...
    private void sendMessage() {
        ...
        message.setTimesstamp(timestamp);
            ...
            FirebaseFirestore.getInstance().collection("/conversations")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            contact.setTimestamp(message.getTimesstamp());
    ...
    private class MessageItem extends Item{
        ...
        public void bind(@NonNull GroupieViewHolder viewHolder, int position) {
            ...
            Picasso.get().load(user.getProfileUrl()).into(imgMessage);
        }
